			  ...
			  <div class="col-lg-2">
				<div class="input-group">
					<span class="input-group-addon">角色</span>
						<select class="form-control" name="expressTypeId" id = "txt_search_expressTypeId" aria-required="true" required>
					...
					<form id="form_user" method="post" action="reserveUser.htm">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							<tr>
								...
								<td>性别：</td>
								<td>
								<input type="radio" id="sex" name="sex" value="男" required/>男
								<input type="radio" id="sex" name="sex" value="女" required/>女
								</td>
							</tr>
								<tr>
								<td>特点：</td>
								<td>
								<input type="checkbox" id="expressTrait1" name="expressTrait" value="耐心" required/>耐心
								<input type="checkbox" id="expressTrait2" name="expressTrait" value="干练" required/>干练
								<input type="checkbox" id="expressTrait3" name="expressTrait" value="效率"required/>效率
								</td>
								<td>&nbsp;&nbsp;</td>
								<td>入职时间：</td>
